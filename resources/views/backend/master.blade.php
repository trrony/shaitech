...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="{{asset('/')}}backend/{{asset('/')}}backend/assets/images/favicon.ico" type="image/x-icon">
				...
				<div class="">
					...
					<div class="collapse" id="nav-user-link">
						<ul class="list-unstyled">
							...
							<li class="list-group-item"><a href="auth-normal-sign-in.html" onclick="logoutForm()"><i class="feather icon-log-out m-r-5"></i>
								Logout
							</a>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu">
					    ...
					    <ul class="pcoded-submenu">
					        <li><a href="{{route('category.add')}}" target="_blank">Add Category</a></li>
					        <li><a href="{{route('category.manage')}}" target="_blank">Manage Category</a></li>
					    </ul>
					</li>
					 ...
					 <li class="nav-item pcoded-hasmenu">
						...
						<ul class="pcoded-submenu">
							...
							<li><a href="{{route('sub-category.manage')}}">All Sub Category</a></li>
		
						
						</ul>
					</li>
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-box"></i></span><span class="pcoded-mtext">Brand</span></a>
						<ul class="pcoded-submenu">
					...
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Product</span></a>
						<ul class="pcoded-submenu">
					...
					<li class="nav-item pcoded-hasmenu">
						<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Project</span></a>
						<ul class="pcoded-submenu">
							<li><a href="{{route('project.add')}}">Add Project</a></li>
							<li><a href="{{route('project.manage')}}">Manage Project</a></li>
						</ul>
					</li>
					<li class="nav-item">
					    <a href="{{route('customer.message')}}" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Customer Message</span></a>
					</li>
							...
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									...
									<ul class="pro-body">
										...
										<li>
											<a href="{{route('logout')}}" onclick="event.preventDefault(); logoutForm().submit()" class="dropdown-item"><i class="feather icon-log-out"></i>
												 Log Out
                ...
                <ul class="iew-download">
                    <li>
                        <a href="http://www.google.com/chrome/">
                            <img src="{{asset('/')}}backend/assets/images/browser/chrome.png" alt="Chrome">
                            <div>Chrome</div>
                        </a>
                    </li>
                    <li>
